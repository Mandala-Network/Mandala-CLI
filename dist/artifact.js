...
export async function buildArtifact(nameOrIndex) {
...
export function findArtifacts() {
    return fs.readdirSync(process.cwd()).filter(f => (f.startsWith(MANDALA_ARTIFACT_PREFIX) || f.startsWith(LEGACY_ARTIFACT_PREFIX)) &&
