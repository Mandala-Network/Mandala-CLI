...
export let walletClient: WalletInterface = new WalletClient('auto', 'localhost');
export let authFetch = new AuthFetch(walletClient);

export const remakeWallet = async (key: HexString, network: WalletNetwork = 'mainnet', storage?: string) => {
